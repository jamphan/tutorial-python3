...
Explaination:
    - Line 39: the input() function polls the user to enter text
    ...
    - line 41: Because there is a chance of a non-valid input (not a number) we
    ...
    - line 41: The `.isnumeric()` is called a method. These are similar to functions
    ...
    - Line 42: Because we now know the input is indeed a number, we need to convert
    ...
    - Line 43: Because we want to display the output , we need to cast the Integer
      back as a string
